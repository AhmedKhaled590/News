...
function getNews() {
    axios.get('http://newsapi.org/v2/top-headlines?country=gb&category=sports&apiKey=b2a4d4a93297428c9975515e525fc4b7')
        .then(res => {
        ...
        axios.get('http://newsapi.org/v2/top-headlines?country=us&category=sports&apiKey=b2a4d4a93297428c9975515e525fc4b7')
        .then(res => {
            const cryptos = res.data
            var i = 0;
            for (var obj in cryptos.articles) {
