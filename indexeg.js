...
function getNews() {
    console.log(con)
    axios.get('http://newsapi.org/v2/top-headlines?country=eg&apiKey=b2a4d4a93297428c9975515e525fc4b7')
        .then(res => {
            ...
            for (var obj in cryptos.articles) {
                ...
                <div class="card-body">
                  ...
                  <a target=_blank href="${cryptos.articles[i].url}" class="btn btn-primary">Read more</a>
                </div>
              </div>
              `;
                i++;
